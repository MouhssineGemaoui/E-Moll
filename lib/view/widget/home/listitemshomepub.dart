    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          //   Text(""),
          // ]),),
                if (itemsModel.itemsActive == 1  && itemsModel.itemsCat  == 8)
          Container(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          //   Text(""),
          // ]),),
                if (itemsModel.itemsActive == 1  && itemsModel.itemsCat  == 12)
          Container(
             width: MediaQuery.of(context).size.width /3.3,
            margin: EdgeInsets.symmetric(horizontal: 5, vertical: 2),
            decoration: BoxDecoration(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          //   Text(""),
          // ]),),
                if (itemsModel.itemsActive == 1  && itemsModel.itemsCat  == 17)
          Container(
             width: MediaQuery.of(context).size.width /3.3,
            margin: EdgeInsets.symmetric(horizontal: 5, vertical: 2),
            decoration: BoxDecoration(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          //   Text(""),
          // ]),),
                if (itemsModel.itemsActive == 1  && itemsModel.itemsCat  == 18)
          Container(
             width: MediaQuery.of(context).size.width /3.3,
            margin: EdgeInsets.symmetric(horizontal: 5, vertical: 2),
            decoration: BoxDecoration(
