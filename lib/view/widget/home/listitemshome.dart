...
class ListItemsHome1 extends GetView<HomeControllerImp> {
  const ListItemsHome1({Key? key}) : super(key: key);
...
class ItemsHome1 extends GetView<HomeControllerImp> {
  final ItemsModel itemsModel;
  const ItemsHome1({Key? key, required this.itemsModel}) : super(key: key);
...
class ItemsHome2 extends GetView<HomeControllerImp> {
  final ItemsModel itemsModel;
...
class ListItemsHome3 extends GetView<HomeControllerImp> {
  const ListItemsHome3({Key? key}) : super(key: key);
...
class ItemsHome3 extends GetView<HomeControllerImp> {
  final ItemsModel itemsModel;
  const ItemsHome3({Key? key, required this.itemsModel}) : super(key: key);
...
class ListItemsHome4 extends GetView<HomeControllerImp> {
  const ListItemsHome4({Key? key}) : super(key: key);
...
class ItemsHome4 extends GetView<HomeControllerImp> {
  final ItemsModel itemsModel;
  const ItemsHome4({Key? key, required this.itemsModel}) : super(key: key);
