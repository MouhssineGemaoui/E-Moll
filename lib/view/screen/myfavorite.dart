...
class MyFavorite extends StatelessWidget {
  ...
  Widget build(BuildContext context){
    ...
    Get.put(MyFavoriteController()); 
      HomeControllerImp controllersearch = Get.put(HomeControllerImp());
    ...
    return Scaffold(
      body: Container(
        ...
        child: GetBuilder<MyFavoriteController>(
           ...
           CustomAppBar(
            mycontroller: controllersearch.search!,
            titleappbar: "Find Product",
            // onPressedIcon: () {},
            onPressedSearch: () {
              controllersearch.onSearchItems();
            },
            onChanged: (val) {
              controllersearch.checkSearch(val);
            },
