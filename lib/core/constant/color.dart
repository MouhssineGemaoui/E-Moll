...
class AppColor {
  ...
  static const Color primaryColor = Color(0xff279797);
  static const Color secondColor = Color.fromARGB(255, 75, 165, 165);
  static const Color fourthColor = Color(0xff0d3056);
  static const Color thirdColor = Color.fromARGB(255, 171, 241, 241);
